    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trunk', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='datax_set', to='products.product')),
            ],
            options={
                'verbose_name': 'Propiedad de Producto',
                'verbose_name_plural': '3. Propiedades de Productos',
                'ordering': ['sort'],
                'abstract': False,
