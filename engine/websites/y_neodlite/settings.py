...
host_firebird = '192.168.1.109'  # '192.168.1.109'
port_firebird = '3051' # '3051'
...
#-----------
# host_firebird = '192.168.1.110'  # '192.168.1.109'
# port_firebird = '3050' # '3051'
#-------------
DATABASES = {
    'default': {
    ...
    'firebird1': {
        ...
        'OPTIONS' : {
            'charset':'ISO8859_1', 
            'fb_library_name': fb_library_name # OJO!!! sólo en Mac
        }
    }
...
# STATIC_ROOT = '%s/%s_static' % (DATA_ROOT, SITE_NAME.lower())
#------------------------------
# MEDIA FILES
#-----------------------
...
# MEDIA_ROOT = '%s/%s_media' % (DATA_ROOT, SITE_NAME.lower())
# MEDIA_ROOT = SITE_DIR
print(STATIC_ROOT)
print(MEDIA_ROOT)
