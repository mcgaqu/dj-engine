...
#     ], ],
    ...
    ['mod_make.plans.apps.PlansConfig', [
            ...
            ['Project', 'PlanProjectAdmin1', 2],
            ['ProjectAux', 'PlanProjectAuxAdmin1', 2],
            ['Plan', 'PlanAdmin1', 2],
            ['PlanCV', 'PlanCVAdmin1', 2],
            ['PlanCVProduct', 'PlanCVProductAdmin1', 2],
            ['PlanCVTax', 'PlanCVTaxAdmin1', 2],
    ],],
    #--------------------------------
#     ['mod_order.invoices.apps.InvoicesConfig', [
#             ['Invoice', 'PlanInvoiceAdmin1', 2],
#             # ['PersonAux', 'PersonAuxAdmin1', 1],
#             # ['PersonItem', 'PersonItemAdmin1', 1],
#     ], ],
#     #-----------------------------------------------	
#     ['mod_order.payments.apps.PaymentsConfig', [
#             ['Payment', 'PlanPaymentAdmin1', 2],
#             # ['ProductAux', 'ProductAuxAdmin1', 2],
#             # ['ProductItem', 'ProductItemAdmin1', 1],
#     ],],
    #-----------------------------------------------	
#     ['mod_report.payments.apps.PaymentsConfig', [
